...
OkLab OkLab::sRGBtoOkLab(const sRGB& srgb) {
  ...
  b2 = b2 <= 0.04045 ? b2 / 12.92 : std::pow((b2 + 0.055) / 1.055, 2.4);

  // to Linear LMS
  double l2 = 0.4122214708 * l1 + 0.5363325363 * a1 + 0.0514459929 * b2;
  double a2 = 0.2119034982 * l1 + 0.6806995451 * a1 + 0.1073969566 * b2;
  double b1 = 0.0883024619 * l1 + 0.2817188376 * a1 + 0.6299787005 * b2;
  ...
  // to OkLab
  l2 = 0.2104542553 * l1 + 0.7936177850 * a1 - 0.0040720468 * b2;
  a2 = 1.9779984951 * l1 - 2.4285922050 * a1 + 0.4505937099 * b2;
  b1 = 0.0259040371 * l1 + 0.7827717662 * a1 - 0.8086757660 * b2;
